...
class Withings():
	...
	TOKEN_URL = 'https://wbsapi.withings.net/v2/oauth2' # https://support.withings.com/hc/en-us/articles/360016745358--BREAKING-Deprecating-access-and-refresh-tokens-endpoints
